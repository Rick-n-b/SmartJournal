...
public class NoteStorage {
    ...
    public void save(Note note){
        ...
        try {
            if (!notesDir.exists())
                System.out.println(notesDir.mkdir());
            if(!noteFile.exists())
                System.out.println(noteFile.createNewFile());

            out = new ObjectOutputStream(new FileOutputStream(noteFile));
